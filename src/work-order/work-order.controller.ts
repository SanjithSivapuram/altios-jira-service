...
export class WorkOrderController {
  ...
  @Get('/sync/bulk/sprints/:projectName')
  async syncIssuesToAltios(@Param('projectName') projectBoardId: string) {
    return await this.workOrderService.syncWorkOrderToAltios(projectBoardId);
  }
}
